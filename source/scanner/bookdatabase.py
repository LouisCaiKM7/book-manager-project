...
class database:
    ...
    def insert_user(self, username, email, password_hash, location):
        self.cursor.execute("INSERT INTO Users (username, email, password_hash, location) VALUES (?,?,?,?)", (username, email, password_hash, location))
        self.conn.commit()
        self.conn.close()
